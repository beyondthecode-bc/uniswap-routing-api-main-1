...
describe('quote', function () {
  ...
  const TEST_ERC20_1: { [chainId in ChainId]: () => null | Token } = {
    ...
    [ChainId.TENET_TESTNET]: () => USDC_ON(ChainId.TENET_TESTNET),
    [ChainId.TENET]: () => USDC_ON(ChainId.TENET),
  }
  ...
  const TEST_ERC20_2: { [chainId in ChainId]: () => Token | null } = {
    ...
    [ChainId.TENET_TESTNET]: () => WNATIVE_ON(ChainId.TENET_TESTNET),
    [ChainId.TENET]: () => WNATIVE_ON(ChainId.TENET),
  }
