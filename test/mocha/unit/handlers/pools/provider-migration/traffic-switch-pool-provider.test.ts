...
import { metric } from '@tendieswap/uniswap-smart-order-router/build/main/util/metric'
import { setupTables } from '../../../../dbSetup'
import {
  DAI_MAINNET as DAI,
  USDC_MAINNET as USDC,
} from '@tendieswap/uniswap-smart-order-router/build/main/providers/token-provider'
