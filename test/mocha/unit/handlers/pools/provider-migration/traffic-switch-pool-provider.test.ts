...
import { CachingV3PoolProvider, MetricLoggerUnit, NodeJSCache } from '@aperture_finance/uniswap-smart-order-router'
...
import { metric } from '@aperture_finance/uniswap-smart-order-router/build/main/util/metric'
import { setupTables } from '../../../../dbSetup'
import {
  DAI_MAINNET as DAI,
  USDC_MAINNET as USDC,
} from '@aperture_finance/uniswap-smart-order-router/build/main/providers/token-provider'
